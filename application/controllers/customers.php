...
class Customers extends Person_controller
{
	...
	*/
	function save($customer_id = -1)
	{
		...
		// Use a função explode para separar a string em um array usando a vírgula como delimitador
		$arrayCategorias = explode(",", $this->input->post('category'));

		// Remova elementos vazios no final do array (se houver)
		$arrayCategorias = array_filter($arrayCategorias);
