	...
	*/
	...
	public function save($item_id = -1)
	{
		...
		$item_data = array(
			...
			'altura' => $this->input->post('altura') == '' ? null : $this->input->post('altura'),
			'largura' => $this->input->post('largura') == '' ? null : $this->input->post('largura'),
			'comprimento' => $this->input->post('comprimento') == '' ? null : $this->input->post('comprimento'),
