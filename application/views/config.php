...
<?php echo form_label($this->lang->line('config_language').':', 'language',array('class'=>'wide required')); ?>
	...
	<?php echo form_dropdown('language', array(
		...
		'indonesia'    => 'Indonesia',
		'spanish'   => 'Spanish',
		'portugues'  => 'Português'), $this->config->item('language'));
		?>
	</div>
</div>
...
<legend>Configuração WC</legend>
<br>
<div class="field_row clearfix">	
<?php echo form_label('URL WC :', 'URL WC',array('class'=>'wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'url_wc',
		'id'=>'url_wc',
		'value'=>$this->config->item('url_wc')));?>
	</div>
</div>

<div class="field_row clearfix">	
<?php echo form_label('Consumer Key:', 'Consumer Key',array('class'=>'wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'consumer_key',
		'id'=>'consumer_key',
		'value'=>$this->config->item('consumer_key')));?>
	</div>
</div>

<div class="field_row clearfix">	
<?php echo form_label('Secret Key:', 'Secret Key',array('class'=>'wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'secret_key',
		'id'=>'secret_key',
		'value'=>$this->config->item('secret_key')));?>
	</div>
</div>
