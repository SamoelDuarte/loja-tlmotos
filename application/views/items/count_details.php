...
<table border="0" align="center">
	<tr bgcolor="#FF0033" align="center" style="font-weight:bold">
		<td colspan="4"><?php echo $this->lang->line('items_inventory_data_tracking'); ?></td>
	</tr>
	<tr align="center" style="font-weight:bold">
		<td width="15%"><?php echo $this->lang->line('items_data'); ?></td>
		<td width="25%"><?php echo $this->lang->line('employees_employee'); ?></td>
		<td width="15%"><?php echo $this->lang->line('items_in_out_qty'); ?></td>
		<td width="45%"><?php echo $this->lang->line('items_remarks'); ?></td>
	</tr>
	<?php
